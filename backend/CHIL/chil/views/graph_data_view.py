...
from ..serializers.graph_data_serializer import (
    CryoeggGraphDataSerializer,
    CryowurstGraphDataSerializer
)
...
from ..services.graph_data_service import (
    ...
    cryowurst_graph_get_all,
    cryowurst_graph_create,
    cryowurst_graph_delete,
)
...
class CryowurstGraphDeleteView(APIView):
    """
    Delete cryowurst graph by id
    """

    def delete(self, request, cryowurst_graph_id):
        """Deletes a cryowurst graphs data by id"""
